...
output_file = "D:/PhD/Research/k8s-pod-securityattack/ToolEva/result/checkov1.csv"
sheet_name = "Sheet1"
...
for index, row in df.iterrows():
    ...
    try:
        command = ["cmd.exe", "/c", "D:", "&&", "checkov", "--compact", "--quiet", "--file", file_path]
        # command = [
        #     "powershell.exe",  # Use PowerShell
        #     "-Command",  # Indicate that the following is a PowerShell command
        #     f"checkov --file '{file_path}' --compact --quiet"
        # ]
